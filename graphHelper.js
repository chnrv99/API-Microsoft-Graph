...
async function createCalendarEventAsync() {
  if (!_userClient) {
    throw new Error('Graph has not been initialised form user auth')
  }

  // change values while doing integration
  let subject = 'Testing graph api'
  let payload = {
    'subject' : subject,
    "start": {
      "dateTime": "2023-06-26T03:56:26.708Z",
      "timeZone": "UTC"
    },
    "end": {
      "dateTime": "2023-07-03T03:56:26.708Z",
      "timeZone": "UTC"
    }
  }
...
module.exports.createCalendarEventAsync = createCalendarEventAsync;
